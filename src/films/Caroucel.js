...
function Caroucel() {
  return (
        ...
        <div className="wrapper2">
          <section id="section1" className='section2'>
            <a   href="#section3" className="arrow__btn a2">‹</a>
            <div className="item2">
            ...
            <a href="#section2" className="arrow__btn a2">›</a>
          </section>
          <section id="section2" className='section2'>
            <a className="a2" href="#section1" >‹</a>
            <div className="item2">
          ...
          <section id="section3" className='section2'>
            ...
            <a href="#section1" className="arrow__btn a2">›</a>
          </section>
        </div>
      </div>
